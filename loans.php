...
<head>
	<title>Loans - KARF | AGRI REVOLVING FUND</title>
  <!--meta tags -->
  <meta charset="UTF-8">
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <form action="" method='post' style="border:1px solid #ccc">
    <div class="container">
      ...
      <p>By requesting a loan you agree to our <a href="#" style="color:dodgerblue">Terms & Privacy</a>.</p>
  
      <div class="clearfix">
        <button type="button" class="cancelbtn">Cancel</button>
        <button type="submit" class="signupbtn"> <a href="success_loan.php" style='color:white'>Get a Loan</a> </button>
      </div>
    </div>
  </form>  
